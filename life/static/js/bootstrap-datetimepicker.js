  ...
  var a = function(a, n) {
    var r, i, o, s, d, l, p, c, u, f = {},
        ...
        s || (t = y.find(".timepicker [data-action=togglePeriod]"), a = r.clone().add(r.hours() >= 12 ? -12 : 12, "h"), t.text(r.format("A")), j(a, "h") ? t.removeClass("disabled") : t.addClass("disabled")), o.filter("[data-time-component=hours]").text(r.format(s ? "HH" : "hh")), o.filter("[data-time-component=minutes]").text(r.format("mm")), o.filter("[data-time-component=seconds]").text(r.format("ss")),
          function() {
            var t = y.find(".timepicker-hours table"),
              ...
              n = [],
              r = e("<tr>");
            for (i.hour() > 11 && !s && a.hour(12); a.isSame(i, "d") && (s || i.hour() < 12 && a.hour() < 12 || i.hour() > 11);) a.hour() % 6 == 0 && (r = e("<tr>"), n.push(r)), r.append('<td data-action="selectHour" class="hour' + (j(a, "h") ? "" : " disabled") + '"><div>' + a.format(s ? "HH" : "hh") + "</div></td>"), a.add(1, "h");
            t.empty().append(n)
          }(),
          function() {
            for (var t = y.find(".timepicker-minutes table"), a = i.clone().startOf("h"), r = [], o = e("<tr>"), s = 1 === n.stepping ? 5 : n.stepping; i.isSame(a, "h");) a.minute() % (6 * s) == 0 && (o = e("<tr>"), r.push(o)), o.append('<td data-action="selectMinute" class="minute' + (j(a, "m") ? "" : " disabled") + '"><div>' + a.format("mm") + "</div></td>"), a.add(s, "m");
            t.empty().append(r)
          }(),
          function() {
      ...
      z = function() {
        ...
        }), t ? f : (m && m.hasClass("") && m.toggleClass("active"), e(window).off("resize", I), y.off("click", "[data-action]"), y.off("mousedown", !1), y.removeClass("open"), void setTimeout(function() {
